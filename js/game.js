...
function winner(pl) {
    if (pl === 'r') {
        if (totalpr === 0) {
            ...
            // Update the image source to reflect the new folder structure
            playerroom[0].innerHTML = "<img src='images/crown" + winno + ".png' class='crown'>"; // Updated path
            pmove = 7;
            moves[0] = 0;
            diceRotation(0);
        }
    ...
    if (pl === 'g') {
        if (totalpg === 0) {
            ...
            // Update the image source to reflect the new folder structure
            playerroom[1].innerHTML = "<img src='images/crown" + winno + ".png' class='crown'>"; // Updated path
            moves[1] = 0;
            pmove = 7;
            diceRotation(1);
        }
    ...
    if (pl === 'b') {
        if (totalpb === 0) {
            ...
            // Update the image source to reflect the new folder structure
            playerroom[2].innerHTML = "<img src='images/crown" + winno + ".png' class='crown'>"; // Updated path
            moves[3] = 0;
            pmove = 7;
            diceRotation(3);
        }
...
if (pl === 'y') {
    if (totalpy === 0) {
        ...
        // Update the image source to reflect the new folder structure
        playerroom[3].innerHTML = "<img src='images/crown" + winno + ".png' class='crown'>"; // Updated path
        moves[2] = 0;
        pmove = 7;
        diceRotation(2);
    }
